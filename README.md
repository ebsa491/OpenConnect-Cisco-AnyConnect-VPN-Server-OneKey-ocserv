...
```bash
docker build -t ocserv https://github.com/ebsa491/OpenConnect-Cisco-AnyConnect-VPN-Server-OneKey-ocserv.git
```

3. Run docker container
```bash
docker run --name ocserv --privileged -p 8081:443 -p 8081:443/udp -d ocserv
```
